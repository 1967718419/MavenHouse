...
<body>
	<div>
		...
		<form id="houseForm" name="houseForm"
			action="${pageContext.request.contextPath}/zulist/myzulist" method=post>
			<div class="result-title">
...
<c:forEach items="${userlist.zulist}" var="zulist">
								...
								<td>${userlist.phone}</td>
									...
									<td><a class="link-update"
										href="${pageContext.request.contextPath}/hetong/zukeseehetong?houseId=${zulist.houseId }">查看合同</a>
										&nbsp;&nbsp; <a class="link-del"
										href="${pageContext.request.contextPath}/applyout/insertapplyout?houseId=${zulist.houseId }"
