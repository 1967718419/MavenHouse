...
public class HetongController {
	...
	public String inserthetong(Model model,Hetong hetong){
		...
		System.out.println("id:"+hetong.getHouseId());
		//修改房屋列表状态
		Houselist houselist=houselistService.findhouseid(hetong.getHouseId());
		System.out.println("id2:"+hetong1.getHouseId());
		...
		zulist.setUserlistId(15);//==apply.getUserlistId()
		...
		//从申请列表中删除
		applyService.deletebyhouse_id(hetong.getHouseId());
